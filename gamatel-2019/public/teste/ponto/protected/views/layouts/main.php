...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
            ...
            <header>
                ...
                <?php
                    if (isset(Yii::app()->session['id_pessoa'])){ ?>
                        <a class="logoff" href="<?php echo Yii::app()->createUrl("tempLogin/sair");?>">
                            <span style="margin-top: 4px ">Sair (<?php echo Yii::app()->user->nome_pessoa;?>)</span>
                        </a>
                <?  } ?>
            </header>
            <main>
                ...
                if (isset(Yii::app()->session['id_pessoa'], Yii::app()->controller->menu)){ ?>
                    <nav class="escondeNaImpressao">
                        <span><?php echo Yii::app()->controller->menu['label'];?></span>
                        <ul>
        ...
        <div id="janelaModal" style="display:none">
            <span class="tituloCard"></span>
